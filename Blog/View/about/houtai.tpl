<html lang="ch"><head>
		...
		<title>左右结构项目！</title>
		<script src="http://www.jq22.com/demo/bootstrap-moban20150917/js/jquery.min.js"></script>
		<script src="http://www.jq22.com/demo/bootstrap-moban20150917/js/bootstrap.min.js"></script>
		<script>
			$(function() {
        ...
        <![endif]-->
		<link href="http://www.jq22.com/demo/bootstrap-moban20150917/css/bootstrap.min.css" rel="stylesheet">
		<link rel="stylesheet" type="text/css" href="http://www.jq22.com/demo/bootstrap-moban20150917/css/common.css">
		<link rel="stylesheet" type="text/css" href="http://www.jq22.com/demo/bootstrap-moban20150917/css/slide.css">
		<link rel="stylesheet" type="text/css" href="http://www.jq22.com/demo/bootstrap-moban20150917/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" href="http://www.jq22.com/demo/bootstrap-moban20150917/css/flat-ui.min.css">
		<link rel="stylesheet" type="text/css" href="http://www.jq22.com/demo/bootstrap-moban20150917/css/jquery.nouislider.css">
	</head>
							...
							<div class="tablebody col-lg-10 col-lg-offset-1">
								<div class="row">
									...
									<div class="col-xs-7 expand-col">
										<div class="slider-minmax1 noUi-target">
										<div class="noUi-base noUi-connect-upper noUi-background noUi-horizontal"><div class="noUi-origin noUi-origin-lower noUi-connect" style="left: 16.6667%;"><div class="noUi-handle noUi-handle-lower">5分钟</div></div></div></div>
								...
								<div class="row">
									...
									<div class="col-xs-7 expand-col">
										<div class="slider-minmax2 noUi-target">
										<div class="noUi-base noUi-connect-upper noUi-background noUi-horizontal"><div class="noUi-origin noUi-origin-lower noUi-connect" style="left: 40%;"><div class="noUi-handle noUi-handle-lower">6分钟</div></div></div></div>
										<div class="row top100">
											<span class="left">0</span>
								...
								<div class="row">
									...
									<div class="col-xs-7 expand-col">
										<div class="slider-minmax3 noUi-target">
										<div class="noUi-base noUi-connect-upper noUi-background noUi-horizontal"><div class="noUi-origin noUi-origin-lower noUi-connect" style="left: 16.6667%;"><div class="noUi-handle noUi-handle-lower">10分钟</div></div></div></div>
										<div class="row top100">
											<span class="left">0</span>
								...
								<div class="row">
									...
									<div class="col-xs-7 expand-col">
										<div class="slider-minmax4 noUi-target">
										<div class="noUi-base noUi-connect-upper noUi-background noUi-horizontal"><div class="noUi-origin noUi-origin-lower noUi-connect" style="left: 20%;"><div class="noUi-handle noUi-handle-lower">2次</div></div></div></div>
										<div class="row top100">
											<span class="left">0</span>
								...
								<div class="row">
									...
									<div class="col-xs-7 expand-col">
										<div class="slider-minmax5 noUi-target">
										<div class="noUi-base noUi-connect-upper noUi-background noUi-horizontal"><div class="noUi-origin noUi-origin-lower noUi-connect" style="left: 42.8571%;"><div class="noUi-handle noUi-handle-lower">3天</div></div></div></div>
										<div class="row top100">
											<span class="left">0</span>
								...
								<div class="row">
									...
									<div class="col-xs-7 expand-col">
										<div class="slider-minmax6 noUi-target">
										<div class="noUi-base noUi-connect-upper noUi-background noUi-horizontal"><div class="noUi-origin noUi-origin-lower noUi-connect" style="left: 80%;"><div class="noUi-handle noUi-handle-lower">8天</div></div></div></div>
										<div class="row top100">
											<span class="left">0</span>
...
//						var max = f.bar.offsetWidth - this.offsetWidth;
	...
	-->
		<script src="http://www.jq22.com/demo/bootstrap-moban20150917/js/jquery.nouislider.js"></script>
